...
public class CreateUserHandlerTests
{
	...
	/// <summary>
	/// Tests that an existing user email request throws a validation exception.
	/// </summary>
	[Fact(DisplayName = "Given existing user data When creating user Then throws validation exception")]
